...
const en = {
  ...
  aiModels: {
    ...
    statusCorrupted: "Damaged file",
    statusUnknown: "Not verified yet",
    technicalDetails: "Technical details",
    fieldId: "Identifier",
    fieldFile: "File",
    fieldRuntime: "Runtime",
    fieldSize: "Exact size",
    fieldSha: "SHA-256",
    fieldProvider: "Origin",
    fieldSource: "Pinned source",
    fieldDistribution: "Distribution",
    fieldInference: "Inference",
    bundled: "Bundled with the application",
    notBundled: "Not bundled with the application",
    onDemand: "downloaded on demand",
    localInference: "fully local",
    noNetworkDuringInference: "no network during processing",
  },
  settings: {
    title: "Settings",
    open: "Settings",
